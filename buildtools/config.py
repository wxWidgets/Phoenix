...
def runcmd(cmd, getOutput=False, echoCmd=True, fatal=True, onError=None, cwd=None, env=None):
    """
    ...
    with subprocess.Popen(cmd, shell=True, env=os.environ if env is None else env, cwd=cwd, **otherKwArgs) as sp:
