...
.. note:: 
   ...
   :ref:`Window extended styles <window-extra-styles>`) you can also implement recursive validation.
...
the control itself does (see :ref:`How Events are Processed <how events are processed>`). 
