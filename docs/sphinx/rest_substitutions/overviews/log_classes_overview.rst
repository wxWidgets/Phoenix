...
such as the Python `logging <http://docs.python.org/library/logging.html>`_ module. The short answer is that they're all very 
...
using different log components for different log statements of any level. Please see :ref:`Log Messages Selection <log messages selection>` 
