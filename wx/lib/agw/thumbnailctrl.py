...
def getShadow():
    ...
    sh_tr = wx.Image(six.StringIO(getDataTR())).ConvertToBitmap()
    sh_bl = wx.Image(six.StringIO(getDataBL())).ConvertToBitmap()
    sh_sh = wx.Image(six.StringIO(getDataSH())).Rescale(500, 500, wx.IMAGE_QUALITY_HIGH)
