...
class FMCustomizeDlg(wx.Dialog):
    ...
    def CreateMenusPage(self):
        ...
        self._menuListId = wx.Window.NewControlId()
    ...
    def CreateOptionsPage(self):
        ...
        self._menuStyleID = wx.Window.NewControlId()
        ...
        self._drawVertGradID = wx.Window.NewControlId()
        ...
        self._drawBorderID = wx.Window.NewControlId()
        ...
        self._shadowUnderTBID = wx.Window.NewControlId()
        ...
        self._colourID = wx.Window.NewControlId()
