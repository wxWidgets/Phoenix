...
MENU_EDIT_DELETE_ALL = wx.Window.NewControlId()
MENU_EDIT_ADD_PAGE = wx.Window.NewControlId()
MENU_EDIT_DELETE_PAGE = wx.Window.NewControlId()
MENU_EDIT_SET_SELECTION = wx.Window.NewControlId()
MENU_EDIT_ADVANCE_SELECTION_FWD = wx.Window.NewControlId()
MENU_EDIT_ADVANCE_SELECTION_BACK = wx.Window.NewControlId()
MENU_SET_ALL_TABS_SHAPE_ANGLE = wx.Window.NewControlId()
MENU_SHOW_IMAGES = wx.Window.NewControlId()
MENU_USE_VC71_STYLE = wx.Window.NewControlId()
MENU_USE_DEFAULT_STYLE = wx.Window.NewControlId()
MENU_USE_FANCY_STYLE = wx.Window.NewControlId()
MENU_USE_RIBBON_STYLE = wx.Window.NewControlId()
MENU_SELECT_GRADIENT_COLOUR_FROM = wx.Window.NewControlId()
MENU_SELECT_GRADIENT_COLOUR_TO = wx.Window.NewControlId()
MENU_SELECT_GRADIENT_COLOUR_BORDER = wx.Window.NewControlId()
MENU_SET_PAGE_IMAGE_INDEX = wx.Window.NewControlId()
MENU_HIDE_X = wx.Window.NewControlId()
MENU_HIDE_NAV_BUTTONS = wx.Window.NewControlId()
MENU_USE_MOUSE_MIDDLE_BTN = wx.Window.NewControlId()
MENU_DRAW_BORDER = wx.Window.NewControlId()
MENU_USE_BOTTOM_TABS = wx.Window.NewControlId()
MENU_ENABLE_TAB = wx.Window.NewControlId()
MENU_DISABLE_TAB = wx.Window.NewControlId()
MENU_ENABLE_DRAG_N_DROP = wx.Window.NewControlId()
MENU_DCLICK_CLOSES_TAB = wx.Window.NewControlId()
MENU_USE_VC8_STYLE = wx.Window.NewControlId()
MENU_USE_FF2_STYLE = wx.Window.NewControlId()
MENU_HIDE_ON_SINGLE_TAB = wx.Window.NewControlId()
MENU_HIDE_TABS = wx.Window.NewControlId()
MENU_NO_TABS_FOCUS = wx.Window.NewControlId()

MENU_SET_ACTIVE_TEXT_COLOUR = wx.Window.NewControlId()
MENU_DRAW_TAB_X = wx.Window.NewControlId()
MENU_SET_ACTIVE_TAB_COLOUR = wx.Window.NewControlId()
MENU_SET_TAB_AREA_COLOUR = wx.Window.NewControlId()
MENU_SELECT_NONACTIVE_TEXT_COLOUR = wx.Window.NewControlId()
MENU_GRADIENT_BACKGROUND = wx.Window.NewControlId()
MENU_COLOURFUL_TABS = wx.Window.NewControlId()
MENU_SMART_TABS = wx.Window.NewControlId()
MENU_USE_DROP_ARROW_BUTTON = wx.Window.NewControlId()
MENU_ALLOW_FOREIGN_DND = wx.Window.NewControlId()

MENU_TILE_HORIZONTALLY = wx.Window.NewControlId()
MENU_TILE_VERTICALLY = wx.Window.NewControlId()
MENU_TILE_NONE = wx.Window.NewControlId()
