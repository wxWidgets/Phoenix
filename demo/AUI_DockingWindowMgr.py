...
ID_CreateTree = wx.Window.NewControlId()
ID_CreateGrid = wx.Window.NewControlId()
ID_CreateText = wx.Window.NewControlId()
ID_CreateHTML = wx.Window.NewControlId()
ID_CreateSizeReport = wx.Window.NewControlId()
ID_GridContent = wx.Window.NewControlId()
ID_TextContent = wx.Window.NewControlId()
ID_TreeContent = wx.Window.NewControlId()
ID_HTMLContent = wx.Window.NewControlId()
ID_SizeReportContent = wx.Window.NewControlId()
ID_CreatePerspective = wx.Window.NewControlId()
ID_CopyPerspective = wx.Window.NewControlId()

ID_TransparentHint = wx.Window.NewControlId()
ID_VenetianBlindsHint = wx.Window.NewControlId()
ID_RectangleHint = wx.Window.NewControlId()
ID_NoHint = wx.Window.NewControlId()
ID_HintFade = wx.Window.NewControlId()
ID_AllowFloating = wx.Window.NewControlId()
ID_NoVenetianFade = wx.Window.NewControlId()
ID_TransparentDrag = wx.Window.NewControlId()
ID_AllowActivePane = wx.Window.NewControlId()
ID_NoGradient = wx.Window.NewControlId()
ID_VerticalGradient = wx.Window.NewControlId()
ID_HorizontalGradient = wx.Window.NewControlId()

ID_Settings = wx.Window.NewControlId()
ID_About = wx.Window.NewControlId()
